          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <TextField
                ...
                error={
                  Boolean(touched.totalExperience) &&
              ...
              <TextField
                ...
                error={
                  Boolean(touched.companyExperience) &&
                  Boolean(errors.companyExperience)
                }
                helperText={
                  touched.companyExperience && errors.companyExperience
                }
                sx={{ gridColumn: 'span 2' }}
              />
              <TextField
              ...
              <TextField
                ...
                value={values.bonus}
                name="bonus"
                error={Boolean(touched.bonus) && Boolean(errors.bonus)}
